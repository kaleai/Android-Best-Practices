...
public class GetSimplePhotoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (IntentUtil.isEmpty(getIntent())) {
            return;
        }
        if (getIntent().getIntExtra(KEY_FROM_WAY, VALUE_FROM_ALBUM) == VALUE_FROM_ALBUM) {
            ...
            if (getIntent().getStringExtra(KEY_PHOTO_PATH) == null) {
                ...
                tempPicFile = new File(getIntent().getStringExtra(KEY_PHOTO_PATH));
            }
